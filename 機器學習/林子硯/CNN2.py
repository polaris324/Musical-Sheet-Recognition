...
#**********
#x_train_img, x_test_img = train_test_split(x_img,random_state=101,test_size=0.2)

#y_train_label, y_test_label = train_test_split(y_label,random_state=101,test_size=0.2)
#**********
...
train_history = model.fit(x=x_Train,y=y_Train_OneHot,
                         epochs=500, batch_size=19, verbose=1)#epochs=10, batch_size=200


# In[Import Model]

model.save('Save_Model_note')
